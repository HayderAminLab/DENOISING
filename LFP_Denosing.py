...
class LFP_DENOISING_Function:
    ...
    def denosing(self,lfpChId_raw=None, lfpTimes_raw=None, LfpForms=None,ChsGroups = None,stepVolt=0,signalInversion =0,threshold_low = 210,threshold_high = 2000,samplingRate=None):
        ...
        3.denosing based on the active channels at the same time
        Parameters
        ----------
        ...
        :return:
                lfpChId_new: numpy array,
                    the channel IDs of the LFPs after denosing
                lfpTimes_new: numpy array,
                    the timepoints of the LFPs after denosing
                tempWaveForms_new: numpy array,
                    the waveforms of the LFPs after denosing
    ...
    def AnalyzeExp(self,expFile = None):
        """ The denosing codes main function based on the .bxr file and the parameters set in the beginning of the script.
